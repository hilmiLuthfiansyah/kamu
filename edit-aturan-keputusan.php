        ...
        <div class="page forms-page">
            ...
            <div class="breadcrumb-holder">
                <div style="padding-left: 20px;" class="container-fluid">
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item active"> <h3>Edit Aturan Kredit </h3></li>
                    </ul>
                </div>
            </div>
            <div class="row">
                     <div class="col-lg-12">
                        <div class="card">
                           ...
                           <div class="card-body">
                              ...
                              <form action="edit-aturan-keputusan-proses.php" method="post">
                              <div class="row">
                              ...
                              <div class="col-lg-6" style="margin-bottom:0px;">
                                 <div class="form-group">
                                    <label>Aturan</label>
                                    <input type="text" name="aturan" placeholder="Aturan" class="form-control" value="<?php echo $data['aturan'];?>">
                                 </div>
                              </div>
                           ...
                           <div class="col-lg-6" style="margin-bottom:0px;">
                                 <div class="form-group">
                                    ...
                                    <input type="date" name="tgl_dibuat" placeholder="Tanggal dibuat" class="form-control" value="<?php echo $data['tgl_dibuat'];?>">
                                 </div>
                              </div>
                           </div>
