    ...
    <nav class="side-navbar">
        ...
        <div class="main-menu">
            <ul id="side-main-menu" class="side-menu list-unstyled">
                ...
                <li class="active"> <a href="pegawai.php"><i class="icon-form"></i><span>Data Pegawai</span></a></li>
        ...
        <section class="forms">
            <div class="container-fluid">
                ...
                ?>
                  ...
                  <td><a href='form-edit.php?nip=$data[nip]'>Edit</a>
                <a href='hapus.php?nip=$data[nip]'>Delete</a>
            </td>
                  </tr>		
           <?php
           }
